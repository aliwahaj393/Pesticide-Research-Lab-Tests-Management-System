...
//		cout << "\n\n\n\n\n\n\n\n\n\n";
//		cout << "\t \t \t \t \t    ";
//		cout << "Do you want to use previous saved data." << endl;
//		cout << "\t \t \t \t \t    ";
//		file = once_more();
//	}
//	if (!file)
...
//					while (fullFieldChecker(fields, fieldNo - 1) ? inserter(fields, fieldNo - 1) ? true : false : !(flag = 1));
//					if (flag)
//					{
//						cout << "---------------------------" << endl;
...
//					fieldNo = fieldSelector(), flag = false;
//					while (emptyFieldChecker(fields, fieldNo - 1) ? deleter(fields, fieldNo - 1) ? true : false : !(flag = 1));
//					if (flag)
//					{
//						cout << "----------------------------" << endl;
...
//	cout << "\n*******************************************************************************************************" << endl;
//}
//void save_data(int*Fields)
//{
//	ofstream fout("Data.txt");
//	for (int i = 0, j = 2; i < row*col; i++)
//	{
//		fout << left << setw(10) << Fields[i];
//		if (0 == (i + 1) % col)
//			fout << endl;
//	}
//	system("cls");
